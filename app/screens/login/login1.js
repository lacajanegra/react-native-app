      ...
      <View style={styles.container}>
        ...
        <View style={styles.buttons}>
          <RkButton rkType='clear'>
            <RkText rkType='header7' onPress={this.onPasswordButtonPressed}> Olvidaste tu contraseña?</RkText>
          </RkButton>
        </View>
        <View style={styles.footer}>
          <View style={styles.textRow}>
            <RkText rkType='primary3'>No tienes cuenta?</RkText>
            <RkButton rkType='clear'>
              <RkText rkType='header6' onPress={this.onSignUpButtonPressed}> Crea una aqui</RkText>
            </RkButton>
          </View>
        </View>
      </View>
