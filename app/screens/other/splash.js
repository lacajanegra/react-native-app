...
export class SplashScreen extends React.Component {
  ...
  updateProgress = () => {
    if (this.state.progress === 1) {
      ...
      const randProgress = this.state.progress + (Math.random() * 1);
    ...
    <View style={styles.container}>
      <View>
        ...
        <View style={styles.text}>
          <RkText rkType='light' style={styles.hero}>Medipharm</RkText>
          <RkText rkType='logo' style={styles.appName}>Chile</RkText>
        </View>
      </View>
      <ProgressBar
